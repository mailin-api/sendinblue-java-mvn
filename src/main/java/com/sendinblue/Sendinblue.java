...
public class Sendinblue {
    ...
    public static void main( String[] args ){
        System.out.println("Jar file genrated successfully");
    }
    
    public Sendinblue(String base_url, String api_key) {
        this.base_url = base_url;
        this.api_key = api_key;
        this.timeout = 30000; //default timeout: 30 secs
    }

    public Sendinblue(String base_url, String api_key, int timeout) {
        this.base_url = base_url;
        this.api_key = api_key;
